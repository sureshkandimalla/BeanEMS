...
import { Card, Row, Col, Button, Flex, Menu,Tag,Form,Input,Radio,DatePicker,Select,Space } from 'antd';
...
const EmployeeOnboard=()=>{
  ...
  <Menu onClick={onClick} selectedKeys={[current]} mode="horizontal" items={onBoardingTabs} className="mrgBtm15"/>
            <>
            {current}
            </>
            <Form
     ...
     <Row gutter={24}>
      ...
      <Form.Item label="Street Address 2" name="streetAddress2">
        ...
        <Input placeholder="Enter Zip Code" />
          ...
          <Col span={8}>
          <Form.Item label="State/Provice/Country" name="state"  rules={[
        {
          required: true,
      ...
      <Row gutter={16}>
        <Col span={6}>
          <Form.Item label="Employement Type" name="employementType"  rules={[
        {
          required: true,
          message: 'Please select an option',
        },
