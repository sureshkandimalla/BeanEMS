                ...
                <Tabs className='bean-home-tabs' defaultActiveKey="1" onChange={toggleTabs} items={items}
                    tabBarExtraContent={
                        <Flex gap="small" wrap="wrap">
                            ...
                            <Button type='primary' onClick={showVendorDrawer}><PlusOutlined /> Add Expense</Button>
                            <Button type='primary' onClick={showEmployeeDrawer}><PlusOutlined /> Add Payment</Button>
                        </Flex>
